...
SECRET_KEY = 'django-insecure-88(u4v-1+$swy^=19u(j$%k&1foo9$59+n+=$+horvgz*%4*yp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
SPOTIFY_CLIENT_ID = 'de770a746b9142aca66bc63786f9ecd2'
SPOTIFY_CLIENT_SECRET = '452fae307e9246478ee60ac9ccd903cc'
ALLOWED_HOSTS = []
